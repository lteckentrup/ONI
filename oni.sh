...
### Merge single years and select sea surface temperature
...
cdo -fldmean -sellonlatbox,-170,-120,5,-5 ONI/SST_1971-2015.nc ONI/SST_1971-2015_nino34.nc

### Select time period
cdo selyear,1986/2005 ONI/SST_1971-2015_nino34.nc ONI/SST_1986-2005_nino34.nc

### Calculate base periods updated every five years for time period and 
### create climatology
...
### Calculate anomaly
cdo sub ONI/SST_1986-2005_nino34.nc ONI/climatology.nc ONI/SST_anomaly.nc

### Calculate spatial average and 3-month running mean
cdo -runmean,3 ONI/SST_anomaly.nc ONI/ONI_test.nc
